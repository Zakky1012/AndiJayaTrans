                ...
                <div class="accordion-content p-5 pt-0 flex flex-col gap-5">
                    ...
                    <div class="flex justify-between">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-lg leading-[27px] mt-[2px]">
                                {{ 'Rp. '. number_format($tier->harga * $transaction->nomor_pessenger, 0, ',', '.')}}
                            </p>
                        </div>
                    </div>
                            ...
                            <div class="flex items-center gap-[10px]">
                                <div
                                    ...
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">
                                        {{ \Carbon\Carbon::parse($passenger->date_of_birth->format('d') == $loop->index ? 'selected' : '') }}
                                    </p>
                                </div>
                                <div
                                    class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">
                                        {{ \Carbon\Carbon::parse($passenger->date_of_birth->format('M') == $loop->index ? 'selected' : '') }}
                                    </p>
                                </div>
                                <div
                                    class="flex items-center w-full rounded-full py-3 px-5 gap-[10px] bg-garuda-bg-grey">
                                    <img src="assets/images/icons/note-add-black.svg" class="w-5 flex shrink-0"
                                        alt="icon">
                                    <p class="font-semibold">
                                        {{ \Carbon\Carbon::parse($passenger->date_of_birth->format('Y') == $loop->index ? 'selected' : '') }}
                                    </p>
                                </div>
                            </div>
                        </div>
